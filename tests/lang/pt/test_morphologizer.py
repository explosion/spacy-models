...
@pytest.mark.parametrize(
    ...
    [("pt_bosque-ud-dev01_10.json", 0.96, 0.94)],
)
def test_pt_morphologizer_corpus(NLP, test_file, pos_threshold, morph_threshold):
...
def test_pt_morphologizer_spaces(NLP):
...
def test_pt_morphologizer_return_char(NLP):
    """Ensure spaces are assigned the POS tag SPACE"""
    text = (
