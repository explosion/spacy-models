...
@pytest.mark.parametrize(
    ...
    [("es_ancora-ud-dev001_10.json", 0.95)],
)
def test_es_tagger_corpus(NLP, test_file, accuracy_threshold):
...
def test_es_tagger_return_char(NLP):
    """Ensure spaces are assigned the POS tag SPACE"""
    text = (
